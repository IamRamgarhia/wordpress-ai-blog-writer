		...
		return array(
			...
			'clients'           => array(
				...
				'points' => array(
					...
					__( 'A connected app can read your rules, score and revise drafts, and publish above your threshold.', 'dicecodes-ai-blog-writer' ),
					__( 'Publishing adds the pictures, the search title, the tags and the links from older posts, same as the other way.', 'dicecodes-ai-blog-writer' ),
					__( 'It still cannot write on a schedule, or touch a post it did not create.', 'dicecodes-ai-blog-writer' ),
