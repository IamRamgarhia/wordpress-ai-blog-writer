...
abstract class Blogcraft_Provider {
	...
	protected function explain( $message ) {
		...
		return $message . ' — ' . __( 'That usually means the Model field holds something other than a model id (the name of your API key is the common one). Open Settings and use "Show the models on my account" to pick a real one.', 'blogcraft' );
	}
